    {{-- tab-bar --}}
    <nav class="bg-linear-to-r from-cyan-500 to-blue-500 w-full md:w-16 h-10 md:h-screen flex md:flex-col items-center justify-around md:justify-start md:gap-4 md:pt-2 fixed bottom-0 left-0 z-50">
        {{-- colocation --}}
        <a href="{{route('coloc.index')}}" class="md:p-2 hover:bg-white/20 rounded-md">
        ...
        {{-- invitation --}}
        <a href="{{route('invites')}}" class="md:p-2 hover:bg-white/20 rounded-md">
            <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                <path fill="white"
        ...
        {{-- wallet --}}
        <a href="route('')" class="md:p-2 hover:bg-white/20 rounded-md">
            <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                <path fill="white"
        ...
        @role('admin')
            {{-- Statistic --}}
            <a href="{{route('admin.statistic')}}" class="md:p-2 hover:bg-white/20 rounded-md">
                <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                    <path fill="white"
            ...
            {{-- non-ban --}}
            <a href="{{route('admin.users')}}" class="md:p-2 hover:bg-white/20 rounded-md">
                <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                    <path fill="white"
            ...
            {{-- ban --}}
            <a href="{{route('admin.blocked')}}" class="md:p-2 hover:bg-white/20 rounded-md">
                <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                    <path fill="white"
        ...
        @endrole
        {{-- profile --}}
        <a href="{{ route('auth.profile')}}" class="md:p-2 hover:bg-white/20 rounded-md">
            <svg class="svg-icon w-8 h-8 cursor-pointer" viewBox="0 0 20 20" data--h-bstatus="0OBSERVED">
                <path fill="white"
