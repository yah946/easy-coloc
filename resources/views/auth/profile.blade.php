    ...
    <section id="change_password" class="hidden">
        <form class="flex flex-col gap-4">
            <div class="max-w-md relative">
                <input class="outline-hidden focus:border-none focus:ring-1 focus:ring-yellow-200 password-input border w-full h-8 pl-4 pr-12" type="password" placeholder="Current Password">
            ...
            <div class="max-w-md relative">
                <input class="outline-hidden focus:border-none focus:ring-1 focus:ring-yellow-200 password-input border w-full h-8 pl-4 pr-12" type="password" placeholder="New Password">
                <button class="toggle-password absolute right-3 top-1/2 -translate-y-1/2">
                    <svg class="show-pass cursor-pointer w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                       width="24" height="24" fill="none" viewBox="0 0 24 24">
                       <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="max-w-md relative">
                <input class="outline-hidden focus:border-none focus:ring-1 focus:ring-yellow-200 password-input border w-full h-8 pl-4 pr-12" type="password" placeholder="Confirm New Password">
                <button class="toggle-password absolute right-3 top-1/2 -translate-y-1/2">
                    <svg class="show-pass cursor-pointer w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                       width="24" height="24" fill="none" viewBox="0 0 24 24">
                       <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
