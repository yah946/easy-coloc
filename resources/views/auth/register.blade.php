    ...
    <form method="post">
        ...
        <div class="gap-2 flex flex-col mx-auto p-2">
            <div class="flex flex-col">
                ...
                <input value="{{old('name')}}" id="name" type="text" name="name" required class="bg-gray-700 px-2 py-1 outline-hidden focus:ring-1 focus:ring-yellow-200" placeholder="Mohamed Mostapha">
                @error('name')
            ...
            <div class="flex flex-col">
                ...
                <input id="confirmation" type="password" name="password_confirmation" required class="bg-gray-700 px-2 py-1 outline-hidden focus:ring-1 focus:ring-yellow-200" placeholder="secret">
            </div>
